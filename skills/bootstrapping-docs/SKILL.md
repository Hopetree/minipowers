...
- README.md is part of the document set — register it in `docs/review-state.json` so the reviewing-changes skill tracks it
- `docs/review-state.json` is shared with the reviewing-changes skill — always update it when adding documents
